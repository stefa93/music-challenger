  ...
  return (
    <div className="space-y-6">
      ...
      <PhaseCard
        ...
        description={
          <>
            Status: <span className="font-semibold">waiting</span> - Game ID:{" "}
            <span className="font-bold text-primary">{gameId ?? "..."}</span>
          </>
        }
      >
        {/* QR Code Section */}
      ...
      <CreativeTabs defaultValue="players" className="w-full">
        ...
        <CreativeTabsContent value="players">
          <div className="pt-4"> {/* Replaced PhaseCard with div */}
        ...
        <CreativeTabsContent value="settings">
          <div className="space-y-5 pt-6"> {/* Replaced PhaseCard with div */}
            {/* Rounds Setting */}
